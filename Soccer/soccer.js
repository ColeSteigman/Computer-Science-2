...
Pong = {
  ...
  Defaults: {
    ...
    paddleHeight: 60,
    paddleSpeed:  2,
    paddleSpeed2: 2,     // should be able to cross court vertically   in 2 seconds
  ...
  onkeydown: function(keyCode) {
    switch(keyCode) {
      ...
      case Game.KEY.D:    if (!this.leftPaddle.auto)  this.leftPaddle.moveRight(); break;
      case Game.KEY.A:    if (!this.leftPaddle.auto)  this.leftPaddle.moveLeft(); break;
      case 38:    if (!this.rightPaddle.auto) this.rightPaddle.moveUp();   break;
      case 40:    if (!this.rightPaddle.auto) this.rightPaddle.moveDown(); break;
      case 37:    if (!this.rightPaddle.auto)  this.rightPaddle.moveRight(); break;
      case 39:    if (!this.rightPaddle.auto)  this.rightPaddle.moveLeft(); break;
    }
  },
  ...
  onkeyup: function(keyCode) {
    switch(keyCode) {
      ...
      case Game.KEY.D:    if (!this.leftPaddle.auto)  this.leftPaddle.stopMovingRight(); break;
      case Game.KEY.A:    if (!this.leftPaddle.auto)  this.leftPaddle.stopMovingLeft(); break;
      ...
      case Game.KEY.RIGHT:    if (!this.rightPaddle.auto)  this.rightPaddle.stopMovingRight(); break;
      case Game.KEY.LEFT:    if (!this.rightPaddle.auto)  this.rightPaddle.stopMovingLeft(); break;
  ...
  Paddle: {
    ...
    initialize: function(pong, rhs) {
      ...
      this.minX   = pong.cfg.wallHeight;
      this.maxX   = pong.width - pong.cfg.wallHeight - this.width;
      this.speed  = (this.maxY - this.minY) / pong.cfg.paddleSpeed;
      this.speed2 = (this.maxX - this.minX) / pong.cfg.paddleSpeed2;
